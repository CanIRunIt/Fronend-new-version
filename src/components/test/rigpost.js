...
import styles from './rigpost.module.css';
 ...
 */
    ...
    if(this.state.gamegpuscore){
        gamerigscore = <GamerigScore class={styles.rigscores}      
    ...
    const { selectedOptionram } = this.state;
      ...
      <h1 style={{textAlign: 'center'/* , color: 'white' */, display: 'flex', justifyContent: 'space-around'}}  class={styles.topic}>Minimum requirements rig_</h1>
       ...
       <div class={styles.rig}>   
       <h1>{/* 'Intel '+  */this.state.gamecpu/* .replace('GHz',' GHz') */}_</h1>
       <h1>{this.state.gamegpu}_</h1>
       <h1>{this.state.gamemem}_</h1>
       </div>
       ...
       <GamerigScore      cpu={this.state.gamecpu}
        ...
        {gamerigscore}
        {this.state.cpuscore ?
                <Rigscore class={styles.rigscores}
                cpu={this.state.cpu}
                gpu={this.state.gpu}
                ram={this.state.ram}
...
<Select
  ...
  */}
            ...
            <div className="input-field">
            <button className={styles.btn} /* onClick={() => this.rigscoreHandler()} */>Run Test</button>
                </div>
